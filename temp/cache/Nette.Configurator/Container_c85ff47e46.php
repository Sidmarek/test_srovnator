<?php
// source: C:\xampp\htdocs\srovnator\app/config/config.neon 
// source: C:\xampp\htdocs\srovnator\app/config/config.local.neon 

class Container_c85ff47e46 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\OverviewPresenter' => array(array('application.4')),
			'App\Presenters\SecondPresenter' => array(array('application.5')),
		...
		'services' => array(
			...
			'application.4' => 'App\Presenters\OverviewPresenter',
			'application.5' => 'App\Presenters\SecondPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\srovnator\app',
			'wwwDir' => 'C:\xampp\htdocs\srovnator\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\srovnator\app/../temp',
		));
	}
	...
	{
		$service = new App\Forms\SignFormFactory($this->getService('26_App_Forms_FormFactory'), $this->getService('security.user'));
		return $service;
	}
	...
	/**
	 * @return App\Presenters\OverviewPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\OverviewPresenter($this->getService('database.default.context'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	/**
	 * @return App\Presenters\SecondPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\SecondPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\srovnator\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\srovnator\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\srovnator\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=srovnator', 'root', NULL, array('lazy' => TRUE));
	...
	{
		return new Container_c85ff47e46_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\srovnator\app/../temp/cache/latte');
...
final class Container_c85ff47e46_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_c85ff47e46 $container)
	{
