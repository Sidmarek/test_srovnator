<?php
// source: C:\xampp\htdocs\srovnator\app\presenters/templates/@layout.latte

class Templatec60ec291c454ecc83d41d13d57859a6a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('50c0d96176', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb251c7fb417_head')) { function _lb251c7fb417_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbb12f20840a_scripts')) { function _lbb12f20840a_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
